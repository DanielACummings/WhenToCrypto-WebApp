<template>
	<form @submit.prevent="createSecretCryptoTx" class="text-left">
		<!-- "Which Crypto?" dropdown -->
		<div class="form-group">
			<label for="which-crypto" class="col-form-label">Which Crypto?</label>
			<select id="which-crypto" class="form-control" v-model="newSecretCryptoTx.cryptoId">
		...
		<div class="form-group">
			...
			<select
				v-model="newSecretCryptoTx.transactionType"
				class="form-control"
				id="transaction-type"
				required
			>
		...
		<div class="form-group">
			...
			<input
				type="text"
				v-model="newSecretCryptoTx.date"
				class="form-control"
				id="date"
		...
		<div class="form-group">
			...
			<input
				type="radio"
				v-model="newSecretCryptoTx.posOrNeg"
				id="pos"
				name="pos-or-neg"
				value="pos"
				required
			...
			<input type="radio" v-model="newSecretCryptoTx.posOrNeg" id="neg" name="pos-or-neg" value="neg" />
		...
		<div class="form-group">
			...
			<input
				...
				step="any"
				min="0"
				v-model="newSecretCryptoTx.cryptoAmount"
				class="form-control"
				id="crypto-amount"
				required
			/>
		...
		<div class="form-group">
			...
			<input
				...
				step="any"
				min="0"
				v-model="newSecretCryptoTx.marketValue"
				class="form-control"
				id="market-value"
				required
			/>
		...
		<div class="form-group">
			...
			<input
				type="text"
				v-model="newSecretCryptoTx.notes"
				class="form-control"
				id="notes"
...
export default {
	...
	methods: {
		createSecretCryptoTx(cryptoId) {
			let txData = { ...this.newSecretCryptoTx };
			this.$store.dispatch("createSecretCryptoTx", txData);
			this.newSecretCryptoTx = {
				transactionType: "",
				date: "",
				posOrNeg: "",
				cryptoAmount: 0,
